...
export default function Hero() {
  ...
  return (
    <section className="w-full flex flex-col items-center px-4 md:px-8 pt-20 pb-8 md:pt-24 md:pb-12 min-h-screen justify-center">
      <motion.div
        ...
        >
          ...
          {videoEnded && (
            <motion.div
              ...
              onClick={replayVideo}
            >
              <div className="w-14 h-14 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/20 transition-colors">
                {replayIcon}
              </div>
            </motion.div>
          )}
          ...
          <motion.div
            initial={{ opacity: 1 }}
            animate={{ opacity: showControls && !videoEnded ? 1 : 0 }}
